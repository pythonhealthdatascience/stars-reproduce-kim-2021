...
## 15.43-16.00, : Inspecting outcome from a model run
...
I created an .Rmd file to start processing the results. This required the addition of **rmarkdown** to the renv.
