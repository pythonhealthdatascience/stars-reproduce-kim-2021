...
* "parallel" - **2 minutes 12 seconds** (although 1m10 of that was just it getting set up it seems, as the line `Random seed has been set by clusterSetRNGStream(iseed=3210).`)
