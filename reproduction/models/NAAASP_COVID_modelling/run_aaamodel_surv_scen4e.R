...
v1other$aortaDiameterThresholds <- list(c(3, 4.5, 50), c(3, 4.5, 7), c(3, 4.5, 5.5), c(3, 4.5, 50), c(3, 4.5, 7), c(3, 4.5, 5.5))
attr(v1other$aortaDiameterThresholds, "timeCutPoints") <- c(0.25, 0.5, 0.75, 1, 1.25)
set.seed(3210)
v0$randomSeed<-3210
