...
**TODO: Fix this - it won't be right as it's comparing against 3 month delay rather than 0 month delay - need to combine with surv_s0**

```{r}
make_tab(surv_s1, scale_to = 15376, groupvar = "period") %>%
  # Keep subset of results
