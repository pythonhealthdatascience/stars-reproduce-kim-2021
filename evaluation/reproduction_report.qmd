...
* **Write code to implement scenarios and generate outputs** - write code to find the aaorta sizes of people with abdominal aortic aneurysm related deaths, as well as code to produce all of the tables and figures from the model output
