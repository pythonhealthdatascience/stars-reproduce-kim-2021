...
v1other$aortaDiameterThresholds <- list(c(2.5, 3.0, 4.0, 5.0))  
v1other$monitoringIntervals <- c(5, 5, 1, 0.25, 0.5) ## updated so first interval relates to those normal (e.g. below first threshold), and last interval relates to those contraindicated
v1other$maxNumberMonitor <- c(Inf, Inf, Inf, Inf)
